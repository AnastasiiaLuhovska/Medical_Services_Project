...
export const translations = {
  de: {
    ...
    'about.description': 'Wir sind Ihr vertrauensvoller Partner für alle medizinischen Angelegenheiten in Deutschland. Wir unterstützen Sie bei Terminen, Organisation, Dokumentation und Kommunikation mit Ärzten und Kliniken.\n\nDarüber hinaus helfen wir auch bei allgemeinen Anträgen und Dokumenten, die über den medizinischen Bereich hinausgehen. Unsere Stärke ist, komplexe Abläufe einfach und klar zu erklären und Sie Schritt für Schritt zu begleiten.',
    ...
    'services.service2.title': 'Dolmetschung (Deutsch – Ukrainisch / Russisch)',
    'services.service2.description': 'Medizinische Fachbegriffe, Arztbriefe oder Gespräche – wir sorgen für eine klare und richtige Dolmetschung.',
    ...
    'services.service7.description': 'Dolmetschung und Unterstützung bei wichtigen medizinischen Gesprächen vor Operationen.',
  ...
  en: {
    ...
    'about.description': 'We are your trusted partner for all medical matters in Germany. We support you with appointments, organization, documentation and communication with doctors and clinics.\nIn addition, we also help with general applications and documents that go beyond the medical field. Our strength is to explain complex processes simply and clearly and to accompany you step by step.',
    ...
    'services.service2.title': 'Oral translation',
    ...
    'services.service7.description': 'Translation and support for important medical conversations before operations.',
